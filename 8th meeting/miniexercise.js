...
// dengan menggunakan filter dengan semua negara yang berakhiran sia//
...
// Filter negara yang berakhiran "sia"
const filteredCountries = countries.filter(country => country.endsWith("sia"));

// Cari indeks dari "Indonesia" pada array hasil filter
const indexIndonesia = filteredCountries.findIndex(country => country === "Indonesia");

// Cetak hasil
console.log("Index of Indonesia:", indexIndonesia); // Output: Index of Indonesia:
